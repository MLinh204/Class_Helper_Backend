...
class AttendanceList{
    ...
    async createAttendanceList(title, teacherId, status, createdAt){
        const query = 'INSERT INTO attendance_lists (title, teacher_id, status, created_at) VALUES (?, ?, ?, ?)';
        const [result] = await this.pool.query(query, [title, teacherId, status, createdAt]);
