...
class Teacher extends User{
    ...
    async createTeacher(username, password, role_id, scheduleDate) {
        ...
        const scheduleDays = Array.isArray(validScheduleDate) ? validScheduleDate.join(',') : validScheduleDate;
    ...
    async updateTeacher(id, scheduleDate){
        ...
        const scheduleDays = Array.isArray(scheduleDate) ? scheduleDate.join(',') : scheduleDate;
