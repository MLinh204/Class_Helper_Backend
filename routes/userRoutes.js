...
router.post('/user', verifyToken, verifyRole(roleRequired), userController.createUser);
router.put('/user/:id', verifyToken, userController.updateUser);
router.delete('/user/:id', verifyToken, verifyRole(roleRequired), userController.deleteUser);
router.put('/user/:id/role', verifyToken, verifyRole(roleRequired), userController.updateUserRole);
