...
router.get(
  "/vocab/list/:list_id/search",
  verifyToken,
  vocabController.searchVocab
);
router.get(
  "/vocab/list/:list_id/sort",
  verifyToken,
  vocabController.sortVocabsBy
);
router.post(
  "/vocab/external/list/:list_id",
  verifyToken,
  vocabController.createWithAPI
);
